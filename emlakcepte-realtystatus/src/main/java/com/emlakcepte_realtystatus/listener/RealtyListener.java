package com.emlakcepte_realtystatus.listener;
...
public class RealtyListener {
    ...
    public void realtyListener(Realty realty) {
        String url = "http://localhost:8090/realties/changeStatusOfRealty/"+realty.getId();
        RestTemplate template = new RestTemplate();
        template.put(url, RealtyResponse.class);
